...
def default_config(detector='jungfrau'):
    ...
    config = dict(
        ...
        diode_dict=dict(
            nsLaserEvr_delay_calc="CXI:DG2:BMMON:EVR:TRIG1:BW_TDES",
            nsLaserEvr_width_calc="CXI:DG2:BMMON:EVR:TRIG1:BW_TWIDCALC",
            nsLaserEvr_count="CXI:DG2:BMMON:EVR:TRIG1:CNT",
            nsLaserEvr_event_code="CXI:DG2:BMMON:EVR:TRIG1:EC_RBV",
            nsLaserEvr_rate="CXI:DG2:BMMON:EVR:TRIG1:RATE",
            nsLaserEvr_state="CXI:DG2:BMMON:EVR:TRIG1:TCTL",
            nsLaserEvr_description="CXI:DG2:BMMON:EVR:TRIG1:TCTL.DESC",
            nsLaserEvr_polarity="CXI:DG2:BMMON:EVR:TRIG1:TPOL",
            nsLaserEvr_width_set="CXI:DG2:BMMON:EVR:TRIG1:TWID",
        )
    )
...
def get_config(run_number, detector="jungfrau"):
    ...
    if detector == "jungfrau":
        if run_number in range(263,266):
            config['pad_detectors'][0]['mask'].append('geometry/jungfrau_run10_flare.mask')
    # elif detector == "epix":
