...
#reborn h5 file
re_path = f'/sdf/data/lcls/ds/cxi/cxil1005322/results/hhig/practice_0603/results/reb_hdf5/cxil1005322_r{run}_{detector}_bigMask.h5'

# Backup the reborn HDF5 file to be safe
backup_re_path = f'/sdf/data/lcls/ds/cxi/cxil1005322/results/hhig/practice_0603/results/reb_hdf5/cxil1005322_r{run}_{detector}_bigMask_backup2.h5'
