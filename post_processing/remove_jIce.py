...
#
"""
Remove icy frames in both detectors based on jungfrau

POSTPROCESSING VERSION:
Rewrite to use fmax that is saved in hdf5 files directly
"""
...
h5j_name = reb_dir + f"{exp_id}_{run_str}_jungfrau.h5"
newj_name = reb_dir + f"{exp_id}_{run_str}_jungfrau_noIceJ.h5"
